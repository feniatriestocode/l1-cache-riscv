...
int main(int argc, const char **argv, const char **env)
{
    ...
    // print debugging messages
        ...
        std::cout << std::hex << std::setfill('0')
                    ...
                    << "index=" << std::setw(8) << top->toplevel__DOT__cpu__DOT__IFID_instr << " "
                    << "set=" << std::setw(8) << top->toplevel__DOT__cpu__DOT__EXMEM_ALUOut << " "
                    << "tag=" << std::setw(8) << top->toplevel__DOT__cpu__DOT__EXMEM_MemWriteData << " "
                    << "data=" << std::setw(8) << top->toplevel__DOT__cpu__DOT__EXMEM_ALUOut << " "                      
