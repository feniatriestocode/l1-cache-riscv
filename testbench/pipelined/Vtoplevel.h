...
VL_MODULE(Vtoplevel) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ toplevel__DOT__cpu__DOT__EXMEM_IDEX_MemRead;
    ...
    struct {
        ...
        IData/*31:0*/ toplevel__DOT__cpu__DOT__cpu_IMem__DOT__data[4096];
        IData/*31:0*/ toplevel__DOT__cpu__DOT__cpu_regs__DOT__data[32];
        IData/*31:0*/ toplevel__DOT__cpu__DOT__cpu_DMem__DOT__data[4096];
    };
    ...
    CData/*0:0*/ __VinpClk__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemRead;
    CData/*0:0*/ __VinpClk__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemWrite;
    CData/*0:0*/ __Vclklast__TOP__clock;
    CData/*0:0*/ __Vclklast__TOP__reset;
    CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemRead;
    CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemWrite;
    CData/*0:0*/ __Vclklast__TOP__toplevel__DOT__cpu__DOT__write_ifid;
    CData/*0:0*/ __Vchglast__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemRead;
    CData/*0:0*/ __Vchglast__TOP__toplevel__DOT__cpu__DOT__EXMEM_MemWrite;
    IData/*31:0*/ __Vdly__toplevel__DOT__cpu__DOT__PC;
  ...
  public:
    static void _combo__TOP__6(Vtoplevel__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__8(Vtoplevel__Syms* __restrict vlSymsp);
