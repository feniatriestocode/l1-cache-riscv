...
void Vtoplevel::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declArray(c+276,"toplevel dmem_din", false,-1, 127,0);
        ...
        tracep->declArray(c+269,"toplevel imem_dout", false,-1, 127,0);
        ...
        tracep->declArray(c+269,"toplevel cpu ImemDout", false,-1, 127,0);
        ...
        tracep->declArray(c+276,"toplevel cpu DmemDin", false,-1, 127,0);
        ...
        tracep->declBit(c+280,"toplevel cpu icacheRen", false,-1);
        tracep->declBit(c+18,"toplevel cpu icacheMemWen", false,-1);
        tracep->declBit(c+281,"toplevel cpu icacheHit", false,-1);
        tracep->declArray(c+282,"toplevel cpu icacheDin", false,-1, 127,0);
        tracep->declArray(c+286,"toplevel cpu icacheDout", false,-1, 127,0);
        tracep->declBit(c+290,"toplevel cpu dcacheRen", false,-1);
        tracep->declBit(c+291,"toplevel cpu dcacheWen", false,-1);
        tracep->declBit(c+19,"toplevel cpu dcacheMemWen", false,-1);
        tracep->declBit(c+292,"toplevel cpu dcacheHit", false,-1);
        tracep->declBit(c+293,"toplevel cpu dcacheDirtyBit", false,-1);
        tracep->declArray(c+294,"toplevel cpu dcacheDin", false,-1, 127,0);
        tracep->declArray(c+276,"toplevel cpu dcacheDout", false,-1, 127,0);
        tracep->declBus(c+298,"toplevel cpu bytesAccess", false,-1, 15,0);
        ...
        tracep->declBit(c+281,"toplevel cpu icachecontroller2check cacheHit", false,-1);
        tracep->declArray(c+286,"toplevel cpu icachecontroller2check cacheDout", false,-1, 127,0);
        tracep->declBit(c+6,"toplevel cpu icachecontroller2check memReadReady", false,-1);
        tracep->declArray(c+269,"toplevel cpu icachecontroller2check memDout", false,-1, 127,0);
        ...
        tracep->declBit(c+280,"toplevel cpu icachecontroller2check cacheRen", false,-1);
        tracep->declBit(c+18,"toplevel cpu icachecontroller2check cacheMemWen", false,-1);
        tracep->declArray(c+282,"toplevel cpu icachecontroller2check cacheDin", false,-1, 127,0);
        ...
        tracep->declBit(c+280,"toplevel cpu Icache ren", false,-1);
        tracep->declBit(c+18,"toplevel cpu Icache memWen", false,-1);
        tracep->declArray(c+282,"toplevel cpu Icache dataIn", false,-1, 127,0);
        tracep->declBus(c+16,"toplevel cpu Icache blockAddr", false,-1, 8,0);
        tracep->declBit(c+281,"toplevel cpu Icache hit", false,-1);
        tracep->declArray(c+286,"toplevel cpu Icache dataOut", false,-1, 127,0);
        {int i; for (i=0; i<4; i++) {
        ...
        tracep->declBit(c+292,"toplevel cpu Dcntr cacheHit", false,-1);
        tracep->declBit(c+293,"toplevel cpu Dcntr cacheDirtyBit", false,-1);
        tracep->declArray(c+276,"toplevel cpu Dcntr cacheDout", false,-1, 127,0);
        ...
        tracep->declBit(c+290,"toplevel cpu Dcntr cacheRen", false,-1);
        tracep->declBit(c+291,"toplevel cpu Dcntr cacheWen", false,-1);
        tracep->declBit(c+19,"toplevel cpu Dcntr cacheMemWen", false,-1);
        tracep->declBus(c+298,"toplevel cpu Dcntr cacheBytesAccess", false,-1, 15,0);
        tracep->declArray(c+294,"toplevel cpu Dcntr cacheDin", false,-1, 127,0);
        tracep->declBit(c+1,"toplevel cpu Dcntr memRen", false,-1);
        tracep->declBit(c+2,"toplevel cpu Dcntr memWen", false,-1);
        tracep->declArray(c+276,"toplevel cpu Dcntr memDin", false,-1, 127,0);
        ...
        tracep->declBit(c+290,"toplevel cpu Dcache ren", false,-1);
        tracep->declBit(c+291,"toplevel cpu Dcache wen", false,-1);
        tracep->declBit(c+19,"toplevel cpu Dcache memWen", false,-1);
        tracep->declBus(c+298,"toplevel cpu Dcache bytesAccess", false,-1, 15,0);
        tracep->declBus(c+17,"toplevel cpu Dcache blockAddr", false,-1, 5,0);
        tracep->declArray(c+294,"toplevel cpu Dcache dataIn", false,-1, 127,0);
        tracep->declBit(c+292,"toplevel cpu Dcache hit", false,-1);
        tracep->declBit(c+293,"toplevel cpu Dcache dirtyBit", false,-1);
        tracep->declArray(c+276,"toplevel cpu Dcache dataOut", false,-1, 127,0);
        {int i; for (i=0; i<4; i++) {
        ...
        tracep->declBus(c+336,"toplevel cpu Dcache m", false,-1, 31,0);
        ...
        tracep->declArray(c+269,"toplevel Instruction_Mem dout", false,-1, 127,0);
        tracep->declBit(c+273,"toplevel Instruction_Mem delayed", false,-1);
        tracep->declBit(c+305,"toplevel Instruction_Mem counter_reset", false,-1);
        tracep->declBus(c+274,"toplevel Instruction_Mem delay_counter", false,-1, 3,0);
        tracep->declBus(c+275,"toplevel Instruction_Mem i", false,-1, 31,0);
        tracep->declBus(c+337,"toplevel Instruction_Mem delay_cntr size", false,-1, 31,0);
        ...
        tracep->declBit(c+273,"toplevel Instruction_Mem delay_cntr hold", false,-1);
        tracep->declBus(c+274,"toplevel Instruction_Mem delay_cntr counter", false,-1, 3,0);
        ...
        tracep->declArray(c+276,"toplevel Data_Mem din", false,-1, 127,0);
        ...
        {int i; for (i=0; i<4; i++) {
                tracep->declBus(c+264+i*1,"toplevel Data_Mem temp_din", true,(i+0), 31,0);}}
        tracep->declBit(c+268,"toplevel Data_Mem flag", false,-1);
        ...
        tracep->declBus(c+337,"toplevel Data_Mem delay_cntr size", false,-1, 31,0);
...
void Vtoplevel::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+264,(vlTOPp->toplevel__DOT__Data_Mem__DOT__temp_din[0]),32);
        tracep->fullIData(oldp+265,(vlTOPp->toplevel__DOT__Data_Mem__DOT__temp_din[1]),32);
        tracep->fullIData(oldp+266,(vlTOPp->toplevel__DOT__Data_Mem__DOT__temp_din[2]),32);
        tracep->fullIData(oldp+267,(vlTOPp->toplevel__DOT__Data_Mem__DOT__temp_din[3]),32);
        tracep->fullBit(oldp+268,(vlTOPp->toplevel__DOT__Data_Mem__DOT__flag));
        tracep->fullWData(oldp+269,(vlTOPp->toplevel__DOT__imem_dout),128);
        tracep->fullBit(oldp+273,((0xfU == (IData)(vlTOPp->toplevel__DOT__Instruction_Mem__DOT__delay_counter))));
        tracep->fullCData(oldp+274,(vlTOPp->toplevel__DOT__Instruction_Mem__DOT__delay_counter),4);
        tracep->fullIData(oldp+275,(vlTOPp->toplevel__DOT__Instruction_Mem__DOT__i),32);
        tracep->fullWData(oldp+276,(vlTOPp->toplevel__DOT__cpu__DOT__dcacheDout),128);
        tracep->fullBit(oldp+280,(vlTOPp->toplevel__DOT__cpu__DOT__icacheRen));
        tracep->fullBit(oldp+281,((0U != (IData)(vlTOPp->toplevel__DOT__cpu__DOT__Icache__DOT__hitReg))));
        tracep->fullWData(oldp+282,(vlTOPp->toplevel__DOT__cpu__DOT__icacheDin),128);
        tracep->fullWData(oldp+286,(vlTOPp->toplevel__DOT__cpu__DOT__icacheDout),128);
        tracep->fullBit(oldp+290,(vlTOPp->toplevel__DOT__cpu__DOT__dcacheRen));
        tracep->fullBit(oldp+291,(vlTOPp->toplevel__DOT__cpu__DOT__dcacheWen));
        tracep->fullBit(oldp+292,((0U != (IData)(vlTOPp->toplevel__DOT__cpu__DOT__Dcache__DOT__hitReg))));
        tracep->fullBit(oldp+293,(vlTOPp->toplevel__DOT__cpu__DOT__dcacheDirtyBit));
        tracep->fullWData(oldp+294,(vlTOPp->toplevel__DOT__cpu__DOT__dcacheDin),128);
        tracep->fullSData(oldp+298,(vlTOPp->toplevel__DOT__cpu__DOT__bytesAccess),16);
        ...
        tracep->fullIData(oldp+336,(vlTOPp->toplevel__DOT__cpu__DOT__Dcache__DOT__m),32);
        tracep->fullIData(oldp+337,(4U),32);
    }
}
